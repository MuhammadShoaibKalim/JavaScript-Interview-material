...
// console.log(strLength("Muahamma Shoaib Kalim "));
...
// console.log("Jabeen".slice(-4));
// console.log("shoaib".slice(-4, -2));
// 02: subString()
...
let text = "i       Muhammad Shoaib kalim     ";
